...
This repository contains materials and deliverables developed for a university-level Capstone Design course, including:
...
|:----------:|:------------------|:-------------:|:---------------:|:----------------------------------------|
|`DCSS451-00`|CAPSTONE DESIGN I|Major Required|Prof. Minseok&nbsp;Seo&nbsp;et&nbsp;al.|Department of Computer Science and Software Engineering|

- **📖 References**

| Type | Contents |
|:----:|:---------|
|Lecture Notes|Materials provided by instructors|
